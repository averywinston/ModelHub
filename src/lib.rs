...
#[derive(Debug)]
pub struct ModelHubPlusProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ModelHubPlusProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ModelHubPlus processing");
    
    let mut processor = ModelHubPlusProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ModelHubPlusProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ModelHubPlusProcessor::new(false);
